  ...
  return (
    <div className="dark-section-wrapper">
      ...
      <section className="relative overflow-hidden" style={{ minHeight: "90vh" }}>
        ...
        {/* Dark overlay gradient — z-index acima das imagens */}
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/60 to-black/20" style={{ zIndex: 3 }} />
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent" style={{ zIndex: 3 }} />
